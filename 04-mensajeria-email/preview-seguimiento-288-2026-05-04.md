...
| `wave_2` pendientes | 65 |
| `wave_3` pendientes | 178 |
| Total seguimiento elegible | 288 |

Instituciones principales:

| Institucion | Pendientes |
|---|---:|
| UNAL Bogota | 198 |
| Javeriana | 33 |
| Uninorte | 18 |
...
- [ ] 8 rebotados excluidos o recuperados por flujo separado.
