...
- [agente.md](./agente.md)
  - Brief consolidado del agente
  - Sustituye los prompts anteriores
...
La prioridad comercial no es trabajar los 300 leads al tiempo. Lo eficiente es operar por oleadas:
...
- construir `top 50 listos para atacar hoy`
...
`prompt4.md` estaba vacio al momento de la consolidacion. No aportaba instrucciones nuevas.
