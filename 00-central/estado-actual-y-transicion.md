...
La prioridad ya no es reconciliar una supuesta ola previa. La operacion fue
reiniciada como lanzamiento fresco y `wave_1`/`wave_2`/`wave_3` ya quedaron
ejecutadas con trazabilidad:
...
- `05-datos-y-reportes/operacion-email/contactos-maestro-operativo.csv`: maestro
  vivo para scripts y ERP.
- `04-mensajeria-email/`: plantillas y lotes revisables.
- `05-datos-y-reportes/operacion-email/reportes/`: historial de cortes y
  revisiones.
- `05-datos-y-reportes/operacion-email/runbooks/`: planes de ejecucion fechados.
- `06-redes-sociales/`: historial de narrativa larga de Agora.

## Que cambia desde hoy

- la nueva verdad de mensajes sale desde `04-mensajeria-email/README.md`
- la nueva organizacion de datos sale desde `05-datos-y-reportes/operacion-email/README.md`
...
- 296 primeros contactos enviados registrados desde `ventas@elenxos.com`.
- 299 envios SMTP aceptados al sumar 3 recuperaciones de rebotes.
- 15 rebotes historicos confirmados.
- 284 pendientes de respuesta email.
...
- Siguiente accion: ejecutar el runbook de seguimiento del 2026-05-04 antes de
  cualquier nueva ola.
